...
# Script parameters - must be first executable statement
param(
...
# -------------------------------------------------------------------------
# Entry Point - Invoke Split-Transcript with script parameters
# -------------------------------------------------------------------------
Split-Transcript -InputFile $InputFile -MaxChars $MaxChars -PeriodSeconds $PeriodSeconds -OutDir $OutDir
