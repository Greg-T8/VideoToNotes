...
from notes_generator.prompt_loader import get_normalize_prompt
...
async def normalize_index(
    ...
    prompt_template = get_normalize_prompt()
    prompt = prompt_template.format(raw_index=raw_content)
...
if __name__ == "__main__":
    ...
    sample_path = Path("staging/samples/AI-900_FreeCodeCamp/Index - FreeCodeCamp.txt")
